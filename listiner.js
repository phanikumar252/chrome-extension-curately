...
window.onclick = function (event) {
    ...
    // const popupElements = document.querySelectorAll(".autocomplete-popup");
    // console.log(popupElements, 'popupElements')
    // _.forEach(popupElements, function (currentEle) {
    //     console.log(event.target, 'popupElements', currentEle)
    //     if (event.target !== currentEle) {
    //         currentEle.classList.remove('visible-popup');
    //     }
    // })
}
